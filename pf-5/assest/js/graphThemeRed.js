...
function chartSamples(){		
	if (document.getElementById('line-canvas')) {
		...
		var lineChartData = {
			...
			datasets : [
				{
					fillColor : "rgba(195,0,6,0.3)",
					strokeColor : "rgba(195,0,6,1)",
					pointColor : "rgba(195,0,6,1)",
					pointStrokeColor : "#fff",
					data : [65,59,90,81,56,55,40]
				},
				{
					fillColor : "rgba(220,154,34,0.6)",
					strokeColor : "rgba(220,154,34,1)",
					pointColor : "rgba(220,154,34,1)",
					pointStrokeColor : "#fff",
