...
function chartSamples(){		
	if (document.getElementById('line-canvas')) {
		...
		var lineChartData = {
			...
			datasets : [
				{
					fillColor : "rgba(185,192,205,0.3)",
					strokeColor : "rgba(185,192,205,1)",
					pointColor : "rgba(185,192,205,1)",
					pointStrokeColor : "#fff",
					data : [65,59,90,81,56,55,40]
				},
				{
					fillColor : "rgba(226,225,205,0.6)",
					strokeColor : "rgba(226,225,205,1)",
					pointColor : "rgba(226,225,205,1)",
					pointStrokeColor : "#fff",
