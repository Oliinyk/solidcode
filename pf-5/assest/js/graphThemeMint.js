...
function chartSamples(){		
	if (document.getElementById('line-canvas')) {
		...
		var lineChartData = {
			...
			datasets : [
				{
					fillColor : "rgba(248,245,207,.25)",
					strokeColor : "rgba(248,245,207,.8)",
					pointColor : "rgba(82,208,70,1)",
					pointStrokeColor : "#fff",
					data : [65,59,90,81,56,55,40]
				},
				{
					fillColor : "rgba(194,236,239,0.25)",
					strokeColor : "rgba(194,236,239,0.8)",
	...
	if (document.getElementById('doughnut-canvas')) {
		...
		var doughnutData = [{
			...
			value : 50,
			color : "rgba(79,112,196,0.40)"
		},{
			value : 100,
			color : "rgba(230,126,34,0.40)"
		},{
			value : 40,
			color : "rgba(231,76,60,0.40)"
		},{
