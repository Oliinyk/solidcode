...
function chartSamples(){		
	if (document.getElementById('line-canvas')) {
		...
		var lineChartData = {
			...
			datasets : [
				{
					fillColor : "rgba(189,212,247,0.3)",
					strokeColor : "rgba(189,212,247,1)",
					pointColor : "rgba(189,212,247,1))",
					pointStrokeColor : "#fff",
					data : [65,59,90,81,56,55,40]
				},
				{
					fillColor : "rgba(135,192,170,0.6)",
					strokeColor : "rgba(135,192,170,1)",
					pointColor : "rgba(135,192,170,1)",
					pointStrokeColor : "#fff",
