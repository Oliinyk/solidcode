...
function chartSamples(){		
	if (document.getElementById('line-canvas')) {
		...
		var lineChartData = {
			...
			datasets : [
				{
					fillColor : "rgba(248,245,207,0.3)",
					strokeColor : "rgba(248,245,207,1)",
					pointColor : "rgba(245,245,207,1)",
					pointStrokeColor : "#fff",
					data : [65,59,90,81,56,55,40]
				},
				{
					fillColor : "rgba(194,236,239,0.6)",
					strokeColor : "rgba(194,236,239,1)",
					pointColor : "rgba(194,236,239,1)",
					pointStrokeColor : "#fff",
