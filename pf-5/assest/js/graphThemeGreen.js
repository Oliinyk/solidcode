...
function chartSamples(){		
	if (document.getElementById('line-canvas')) {
		...
		var lineChartData = {
			...
			datasets : [
				{
					fillColor : "rgba(241,200,147,0.3)",
					strokeColor : "rgba(241,200,147,1)",
					pointColor : "rgba(241,200,147,1)",
					pointStrokeColor : "#fff",
					data : [65,59,90,81,56,55,40]
				},
				{
					fillColor : "rgba(139,208,220,0.6)",
					strokeColor : "rgba(139,208,220,1)",
					pointColor : "rgba(139,208,220,1)",
					pointStrokeColor : "#fff",
